...
def scope_for_request(method: str, path: str) -> str | None:
    ...
    if "/addresses" in path:
        # Автодополнение адреса: запрос почти на каждую букву, причём
        # за нами стоит чужой сервис с собственными лимитами.
        return "addresses"
...
_MESSAGES = {
    ...
    "addresses": "Слишком много запросов подсказок адреса. Подождите немного.",
}
